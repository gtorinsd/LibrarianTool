package com.udelphi.trainingcenter.librariantool.DBTools;
...
import com.udelphi.trainingcenter.librariantool.ToolApplication;
...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    public long InsertValuesByContent(String tableName, ContentValues contentValues)
    {
        long l;
        try
        {
            l = m_Database.insert(tableName, null, contentValues);
        }
        catch (Exception ex)
        {
            m_ErrorMsg = ex.getMessage();
